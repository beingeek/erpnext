...
def get_data():
	...
	return [
		...
		{"module_name": "Qty Adjust", "_report": "Qty Adjust", "color": "grey", "type": "link",
			"link": "query-report/Qty Adjust", "label": _("Qty Adjust")},
		{"module_name": "Qty Adjust Log Summary", "_report": "Qty Adjust Log Summary", "color": "grey", "type": "link",
			"link": "query-report/Qty Adjust Log Summary", "label": _("Qty Adjust Log Summary")},

		{"module_name": "Price List", "_report": "Price List", "color": colors["Stock"], "type": "link",
		...
		{"module_name": "Profit and Loss Statement", "_doctype": "Account", "color": colors["Accounts"], "icon": "octicon octicon-repo",
			"type": "link", "link": "query-report/Profit and Loss Statement"},
